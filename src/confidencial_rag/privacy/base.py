...
from .detection import DetectedEntity, EntityDetector, StructuredEntityDetector, default_entity_detector
...
class PrivacySession:
    def __init__(self, custom_terms: list[str] | None = None, *, detector: EntityDetector | None = None,
        ...
        self.detector = detector or default_entity_detector()
...
class PrivacyGateway:
    PATTERNS = StructuredEntityDetector.PATTERNS
